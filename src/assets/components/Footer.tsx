...
const Footer:React.FC = () => {
  return (
    <main className='bg-gradient-to-r from-[#002d28] to-[#022b28] w-full h-full p-5'>
        <section className='flex flex-row-reverse justify-between items-center w-full h-full'>
